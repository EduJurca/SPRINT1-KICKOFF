...
### Backend Protection
- ✅ `UserController::__construct()` verifica autenticació i rol Staff
...
**Solució**: Verifica que el `UserController::__construct()` verifica el role_id
...
2. ✅ AuthController millorat (detecta API vs navegador)
3. ✅ Permissions creat
4. ✅ UserController protegit
5. ✅ Vistes actualitzades amb helpers
6. 🔄 **Aplicar permisos a VehicleController**
7. 🔄 **Aplicar permisos a BookingController**
8. 🔄 **Crear vistes diferents de dashboard segons rol**
