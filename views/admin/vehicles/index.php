                ...
                <div class="flex gap-3">
                    <div class="flex-1 relative">
                        ...
                        <input 
                            ...
                            placeholder="Cercar per matrícula, marca o model..."
                                ...
                                <tr class="hover:bg-gray-50 transition-colors">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                        <div class="flex items-center justify-end gap-2">
                                            <a href="/admin/vehicles/<?= $vehicle['id'] ?>" class="text-gray-500 hover:text-green-600 transition-colors p-2 hover:bg-gray-100 rounded-lg" title="<?= __('admin.vehicles.buttons.view') ?>">
                                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
