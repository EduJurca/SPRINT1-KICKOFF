    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div class="mb-6">
            <div class="flex items-center justify-between">
                <div>
                    <h2 class="text-2xl font-bold text-gray-900"><?= __('admin.vehicles.new') ?></h2>
                    <p class="text-sm text-gray-600 mt-1"><?= __('admin.vehicles.subtitle_create') ?></p>
                </div>
            ...
            <form method="POST" action="/admin/vehicles" class="space-y-6">
                ...
                <div class="flex items-center justify-end gap-4 pt-6 border-t border-gray-200">
                    ...
                    <button type="submit" class="px-6 py-3 bg-[#1565C0] hover:bg-blue-700 text-white rounded-lg font-semibold transition-all flex items-center gap-2 shadow-md hover:shadow-lg">
                        ...
                        <?= __('admin.vehicles.buttons.create') ?>
                    </button>
                </div>
            </form>
        </div>
