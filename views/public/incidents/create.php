...
<body class="bg-gray-100 flex items-center justify-center min-h-screen p-4">
    ...
    <div class="w-full max-w-4xl bg-white p-6 rounded-2xl shadow-lg">
        ...
        <div class="max-w-2xl mx-auto">
            ...
            <div>
                <label for="type" class="block text-sm text-gray-900 font-semibold mb-2"><?php echo __('incident.type'); ?></label>
                ...
                <div>   
                   <label for="description" class="block text-sm text-gray-900 font-semibold mb-2"><?php echo __('incident.description'); ?></label>
                    <input type="text" id="description" name="description" 
                        value="<?php echo htmlspecialchars($fullname ?? ''); ?>" 
                        class="w-full px-2 py-1 bg-[#F5F5F5] text-sm rounded-lg focus:outline-none focus:ring-2 focus:ring-[#1565C0]">
                </div>
