    ...
    <div class="w-full max-w-sm md:max-w-3xl lg:max-w-4xl h-[667px] md:h-auto flex items-center justify-center">
        <div class="bg-white p-5 rounded-2xl shadow-inner w-full h-full flex flex-col relative space-y-6">
            <header class="grid grid-cols-3 items-center mb-6 w-full">
                <div class="text-left">
                    <a href="/profile"
                        class="text-[#1565C0] text-sm font-semibold"><?php echo __('profile.back_to_profile'); ?></a>
                </div>
                <h1 class="text-2xl font-bold text-gray-900 text-center"><?php echo __('profile.trip_history_title'); ?>
                </h1>
            ...
            <main class="flex-1 overflow-y-auto no-scrollbar mt-3">
                <?php if (empty($history)): ?>
                    <div class="text-center py-12">
                        ...
                        <h3 class="text-lg font-semibold text-gray-700 mb-2"><?php echo __('profile.no_trips_title'); ?></h3>
                        <p class="text-gray-500 text-sm"><?php echo __('profile.no_trips_message'); ?></p>
                        <a href="/dashboard"
                            class="inline-block mt-4 bg-[#1565C0] text-white px-6 py-2 rounded-lg hover:bg-[#0d47a1] transition">
                            <?php echo __('profile.no_trips_cta'); ?>
                        </a>
                    </div>
                <?php else: ?>
                    <ul class="space-y-4">
                                ...
                                <div class="flex items-start justify-between gap-4">
                                    <div class="flex-1">
                                        ...
                                        <div class="space-y-1 text-sm text-gray-700">
                                            <p>
                                                <svg class="inline h-4 w-4 mr-1 text-gray-500" fill="none" stroke="currentColor"
                                                    viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                        d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z">
                                                    </path>
                                                </svg>
                                                <strong><?php echo __('dashboard.date'); ?></strong>
                                            ...
                                            <?php if ($trip['end_time']): ?>
                                                <p>
                                                    ...
                                                    <strong><?php echo __('dashboard.duration'); ?></strong>
                                                        <?php echo htmlspecialchars($trip['duration_minutes'] ?? 0); ?> <?php echo __('dashboard.minutes'); ?>
                                                </p>
                                            <?php else: ?>
                                                <p class="text-orange-600">
                                                    ...
                                                    <strong><?php echo __('profile.in_progress'); ?></strong>
                                                </p>
                                            <?php endif; ?>
                                            ...
                                            <?php if ($trip['total_distance_km']): ?>
                                                <p>
                                                    ...
                                                    <strong><?php echo __('vehicle.distance'); ?></strong>
                                            ...
                                            <?php if ($trip['start_location_name']): ?>
                                                <p class="text-xs text-gray-600 mt-2">
                                                    ...
                                                    <?php echo __('profile.origin'); ?> <?php echo htmlspecialchars($trip['start_location_name']); ?>
                                                </p>
                                            <?php endif; ?>
                                            ...
                                            <?php if ($trip['end_location_name']): ?>
                                                <p class="text-xs text-gray-600">
                                                    ...
                                                    <?php echo __('profile.destination'); ?> <?php echo htmlspecialchars($trip['end_location_name']); ?>
                                                </p>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                    ...
                                    <?php else: ?>
                                        <div
                                            class="w-24 h-24 bg-gray-300 rounded-md flex items-center justify-center flex-shrink-0">
