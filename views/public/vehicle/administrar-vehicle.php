...
<body class="bg-gray-100 flex items-center justify-center min-h-screen p-4">
    <div class="w-full max-w-4xl bg-white p-6 rounded-2xl shadow-lg">
        ...
        <div class="mobile-view md:hidden">
            <div class="p-5 rounded-2xls w-full max-w-sm flex flex-col relative mb-20">
                <header class="grid grid-cols-3 items-center mb-6 w-full">
                    <div class="text-left">
                        <a href="/dashboard"
                            class="inline-flex items-center gap-2 text-[#1565C0] font-semibold hover:underline py-1 px-2 rounded-lg border border-transparent hover:border-gray-200">
                            <?php echo __('admin.back'); ?>
                        </a>
                    </div>
                    <h1 class="text-2xl font-bold text-gray-900 text-center"><?php echo __('admin.control_vehicle'); ?>
                    </h1>
                    <div class="flex justify-end items-center gap-2">
                        <img src="/assets/images/logo.png" alt="<?php echo __('admin.logo_alt'); ?>"
                            class="h-10 w-10 ">
                    </div>
                </header>

                <div class="w-full px-2 mt-3">
                    <button id="release-vehicle-btn-mobile" aria-label="Finalitzar Reserva"
                        class="block w-full bg-red-600 hover:bg-red-700 text-white font-bold py-3 rounded-lg text-sm transition-colors"
                        title="Finalitzar Reserva">
                ...
                <div
                    class="mb-4 sticky top-0 z-10 bg-white p-2 rounded-lg shadow-sm flex flex-row justify-between items-center gap-2">
                    <div class="pushable green flex-1">
                        ...
                        <span class="front p-2 flex flex-col items-center text-sm">
                            ...
                            <span class="text-sm font-semibold"
                                data-vehicle-status><?php echo __('admin.operational'); ?></span>
                        </span>
                    </div>
                    <div class="pushable flex-1">
                        ...
                        <span class="front p-2 flex flex-col items-center text-sm"
                            ...
                            <span class="text-white text-base font-semibold"><?php echo __('admin.battery'); ?></span>
                            <div class="w-full bg-gray-300 rounded-lg h-6 overflow-hidden mt-1">
                                <div class="h-full" data-battery-bar style="width: 80%; background-color: #00C853;">
                                    <div class="h-full flex items-center justify-center text-white font-bold text-sm"
                                        data-battery-text>80%</div>
                                </div>
                            </div>
                        </span>
                    </div>
                ...
                <main class="flex-1 overflow-x-auto no-scrollbar flex snap-x snap-mandatory pb-20">
                        ...
                        <div class="grid grid-cols-2 gap-4 sm:gap-6 p-2">
                            <button class="pushable yellow h-32" data-control="engine">
                                ...
                                <span class="front flex-1 flex flex-col items-center justify-center text-base p-2">
                                    <img src="/assets/images/engegar.png"
                                        alt="<?php echo __('admin.start_stop_alt'); ?>" class="h-12 w-12 mb-2">
                            ...
                            <button class="pushable h-32" data-control="horn">
                                ...
                                <span class="edge"></span>
                                <span class="front flex-1 flex flex-col items-center justify-center text-base p-2">
                                    <img src="/assets/images/claxon.png" alt="<?php echo __('admin.activate_horn'); ?>"
                            ...
                            <button class="pushable h-32" data-control="lights">
                                ...
                                <span class="edge"></span>
                                <span class="front flex-1 flex flex-col items-center justify-center text-base p-2">
                                    <img src="/assets/images/llums.png" alt="<?php echo __('admin.activate_lights'); ?>"
                                        class="h-12 w-12 mb-2">
                            ...
                            <button class="pushable h-32" data-control="doors">
                                ...
                                <span class="edge"></span>
                                <span class="front flex-1 flex flex-col items-center justify-center text-base p-2">
                                    <img src="/assets/images/portes.png" alt="<?php echo __('admin.lock_doors'); ?>"
                                        class="h-12 w-12 mb-2">
                    ...
                    <!-- Information & Location (license/model + mobile map) -->
                    <section class="flex-none w-full px-2 sm:px-4 flex flex-col justify-center snap-start">
                        <h2 class="text-xl font-bold text-gray-900 mb-4"><?php echo __('admin.info_location'); ?></h2>
                        <div class="bg-[#F5F5F5] p-4 rounded-lg mb-4">
                            <p class="text-gray-900 font-semibold text-lg mb-1"><?php echo __('admin.license_plate'); ?> <span class="font-normal" data-vehicle-license><?php echo __('admin.loading'); ?>...</span></p>
                            <p class="text-gray-700"><?php echo __('admin.model'); ?> <span class="font-normal" data-vehicle-model><?php echo __('admin.loading'); ?>...</span></p>
                        </div>
                        <div class="w-full rounded-lg overflow-hidden" style="height:220px;">
        ...
        <div class="desktop-view hidden md:block bg-white p-8 rounded-2xl shadow-inner w-full max-w-5xl mx-auto mb-20">
            <header class="grid grid-cols-3 items-center mb-6 w-full">
                ...
                <div class="flex justify-end items-center gap-3">
                    <button id="release-vehicle-btn-desktop"
            ...
            <div
                class="mb-6 sticky top-0 z-10 bg-white p-4 rounded-lg shadow-sm flex flex-row justify-center items-center gap-8">
                <div class="pushable flex-1 max-w-xs">
                    ...
                    <span class="front p-3 flex flex-col items-center text-base"
                        style="background: hsl(140, 80%, 45%);">
                        <span class="font-semibold"><?php echo __('admin.status'); ?></span>
                        <span class="text-white font-semibold h-8 mt-2"
                            data-vehicle-status><?php echo __('admin.operational'); ?></span>
                    </span>
                </div>
                <div class="pushable flex-1 max-w-xs">
                    ...
                    <span class="front p-3 flex flex-col items-center text-base"
                        ...
                        <div class="w-full bg-gray-300 rounded-lg h-8 overflow-hidden mt-2">
                            <div class="h-full" data-battery-bar style="width: 80%; background-color: #00C853;">
                                <div class="h-full flex items-center justify-center text-white font-bold text-base"
                                    data-battery-text>80%</div>
                            </div>
                        </div>
                    </span>
            ...
            <main class="flex flex-row gap-8 pb-20">
                    ...
                    <div class="grid grid-cols-2 gap-8">
                        <button class="pushable yellow h-40" data-control="engine">
                            ...
                            <span class="front flex flex-col items-center justify-center text-lg p-4">
                                <img src="/assets/images/engegar.png" alt="<?php echo __('admin.start_stop_alt'); ?>"
                ...
                <section class="flex-1 flex flex-col">
                    ...
                    <div class="bg-[#F5F5F5] p-6 rounded-lg mb-6">
                        <p class="text-gray-900 font-semibold text-xl mb-2"><?php echo __('admin.license_plate'); ?>
                            <span class="font-normal" data-vehicle-license><?php echo __('admin.loading'); ?>...</span>
                        </p>
                        <p class="text-gray-700 text-lg"><?php echo __('admin.model'); ?> <span class="font-normal"
                                data-vehicle-model><?php echo __('admin.loading'); ?>...</span></p>
                    </div>
                    ...
                    <section class="flex-1 flex flex-col">
                        <h3 class="text-xl font-bold text-gray-900 mb-4"><?php echo __('admin.vehicle_info'); ?></h3>
                        <ul class="space-y-4 text-base">
                            <li class="bg-[#F5F5F5] p-4 rounded-lg"><strong><?php echo __('admin.battery_level'); ?></strong>: <span id="battery-level-desktop">85%</span></li>
        ...
        <div id="release-modal" class="hidden fixed inset-0 bg-black bg-opacity-50 items-center justify-center p-4"
            style="z-index: 9999;">
