...
<button id="chat-toggle" class="<?php echo isset($hideChatToggle) && $hideChatToggle ? 'hidden' : 'flex'; ?> fixed bottom-6 right-6 bg-blue-600 hover:bg-blue-700 text-white rounded-full p-4 shadow-lg transition-all duration-300 z-50 items-center justify-center" aria-label="<?php echo __('chat.open_assistant'); ?>">
