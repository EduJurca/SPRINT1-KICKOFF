...
try {
    ...
    $debug['bookings_table_exists'] = $checkTable->num_rows > 0;
    ...
    if ($userId && $debug['bookings_table_exists']) {
        ...
        $debug['vehicles_in_use'] = $result2->fetch_all(MYSQLI_ASSOC);
    }
